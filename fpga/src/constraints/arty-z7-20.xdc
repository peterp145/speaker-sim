...
## Clock Signal
set_property -dict {PACKAGE_PIN H16 IOSTANDARD LVCMOS33} [get_ports i_clk_125M]
create_clock -period 8.000 -name sys_clk_pin -waveform {0.000 4.000} -add [get_ports i_clk_125M]
...
## LEDs
set_property -dict {PACKAGE_PIN R14 IOSTANDARD LVCMOS33} [get_ports {o_leds[0]}]
set_property -dict {PACKAGE_PIN P14 IOSTANDARD LVCMOS33} [get_ports {o_leds[1]}]
set_property -dict {PACKAGE_PIN N16 IOSTANDARD LVCMOS33} [get_ports {o_leds[2]}]
set_property -dict {PACKAGE_PIN M14 IOSTANDARD LVCMOS33} [get_ports {o_leds[3]}]
...
## Pmod Header JB
set_property -dict {PACKAGE_PIN W14 IOSTANDARD LVCMOS33} [get_ports o_codec_dclk]
set_property -dict {PACKAGE_PIN Y14 IOSTANDARD LVCMOS33} [get_ports o_codec_din]
set_property -dict {PACKAGE_PIN T11 IOSTANDARD LVCMOS33} [get_ports o_codec_dfs]
set_property -dict {PACKAGE_PIN T10 IOSTANDARD LVCMOS33} [get_ports i_codec_dout]
set_property -dict {PACKAGE_PIN V16 IOSTANDARD LVCMOS33} [get_ports o_codec_mclk]
...
set_property -dict {PACKAGE_PIN W13 IOSTANDARD LVCMOS33} [get_ports o_codec_rst_n]
