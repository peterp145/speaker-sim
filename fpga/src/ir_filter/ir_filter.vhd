...
-- -------------------------------------------------------------
-- Model base rate: 8.68056e-10
-- Target subsystem base rate: 8.68056e-10
-- 
-- 
...
-- -------------------------------------------------------------
-- data_out                      ce_out        8.68056e-10
-- data_out_valid                ce_out        8.68056e-10
-- data_in_ready                 ce_out        8.68056e-10
-- -------------------------------------------------------------
-- 
-- -------------------------------------------------------------
...
ARCHITECTURE rtl OF ir_filter IS
  ...
  SIGNAL Extract_Bits_out1                : signed(23 DOWNTO 0);  -- sfix24
...
BEGIN
  ...
  Data_Type_Conversion1_out1 <= w_data_in(23 DOWNTO 8) + ('0' & (w_data_in(7) AND (w_data_in(8) OR (w_data_in(6) OR w_data_in(5) OR w_data_in(4) OR w_data_in(3) OR w_data_in(2) OR w_data_in(1) OR w_data_in(0)))));
  ...
  Extract_Bits_out1 <= signed(s_and_h_out1(35 DOWNTO 12));
  ...
  data_out_valid <= w_data_out_valid;
