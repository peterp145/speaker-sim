...
ARCHITECTURE rtl OF ir_filter IS
  ...
  SIGNAL w_data_in_1                      : signed(23 DOWNTO 0) := (OTHERS => '0');  -- sfix24_En23
  SIGNAL w_data_in_valid_1                : std_logic := '0';
  SIGNAL fir_filter_hdl_out1              : signed(23 DOWNTO 0);  -- sfix24_En23
  SIGNAL w_data_out_valid                 : std_logic;
  SIGNAL fir_filter_hdl_out3              : std_logic;
  SIGNAL fir_filter_hdl_out1_1            : signed(23 DOWNTO 0) := (OTHERS => '0');  -- sfix24_En23
...
BEGIN
  u_fir_filter_hdl : fir_filter_hdl
    PORT MAP( i_clk_dsp_122M88 => i_clk_dsp_122M88,
              ...
              en => clk_enable,
              en_1_1_1 => clk_enable,
              dataIn => w_data_in_1,  -- sfix24_En23
              validIn => w_data_in_valid_1,
              dataOut => fir_filter_hdl_out1,  -- sfix24_En23
  ...
  u_s_and_h : s_and_h
    PORT MAP( i_clk_dsp_122M88 => i_clk_dsp_122M88,
              reset => reset,
              en => clk_enable,
              In_rsvd => fir_filter_hdl_out1_1,  -- sfix24_En23
